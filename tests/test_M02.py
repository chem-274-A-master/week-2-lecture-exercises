...
def test_02_01_01():
    ...
    with pytest.raises(
        InvalidDistanceError, match="Distance must be greater than or equal to zero."
    ):
        is_bond(-0.5)
...
def test_02_01_02():
    ...
    assert result is True, (
        "The function should return True for a distance within the bonding range."
    )
...
def test_02_01_03():
    ...
    assert result is False, (
        "The function should return False for a distance above the max bonding distance."
    )
...
def test_02_02_01():
    ...
    assert ion.electrons == 9, (
        "Ion with +1 charge should have one less electron than protons."
    )
...
def test_02_02_02():
    ...
    assert ion.electrons == 11, (
        "Ion with -1 charge should have one more electron than protons."
    )
...
def test_02_02_03():
    ...
    assert ion.electrons == 10, (
        "Ion with neutral charge should have electrons equal to protons."
    )
