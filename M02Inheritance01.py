"""
In Python, one common use of inheritance is to create custom exceptions that are more descriptive for specific situations.
In this exercise, you will create a custom exception class called `InvalidDistanceError`.
Your custom exception should inherit from Python's built-in `Exception` class.
...
def is_bond(distance: float, max_distance: float = 0.95) -> bool:
    """
