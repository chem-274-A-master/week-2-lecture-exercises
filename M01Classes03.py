...
add a class attribute called `conversion_factor` that holds the conversion factor to convert nanometers to Ångström 
(you will need to figure out what the conversion factor is).

Modify your `stretch` instance method to take an optional argument named "angstrom". 
The default value for this optional argument should be True.
